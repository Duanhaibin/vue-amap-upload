<template>
	<header class="banner"> 
		...
		<swiper loop auto  height='4rem'  dots-position="center" :list="urlList" :index="banner_index" @on-index-change="banner_onIndexChange"></swiper>
		<!-- <p>current index: {{banner_index}}</p> -->
	</header>
